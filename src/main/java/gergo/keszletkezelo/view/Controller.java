package gergo.keszletkezelo.view;
...
import gergo.keszletkezelo.domain.Employee;
import gergo.keszletkezelo.domain.Invoice;
import gergo.keszletkezelo.domain.Partner;
import gergo.keszletkezelo.domain.Shop;
import gergo.keszletkezelo.domain.Wine;
import gergo.keszletkezelo.repository.DBEmployee;
import gergo.keszletkezelo.repository.DBEmployeePassword;
import gergo.keszletkezelo.repository.DBInvoice;
import gergo.keszletkezelo.repository.DBPartner;
import gergo.keszletkezelo.repository.DBShop;
import gergo.keszletkezelo.repository.DBWine;
import gergo.keszletkezelo.repository.DBWineStock;
import gergo.keszletkezelo.service.pdfGeneration;
...
//        TreeItem<String> treeItemRoot = new TreeItem<>("Menü");
        ...
        Node invoicePict = new ImageView(new Image(getClass().getResourceAsStream("/images/invoice.png")));
        Node wineByCountryList = new ImageView(new Image(getClass().getResourceAsStream("/images/wineByCountryList.png")));
        Node addPartnerPict = new ImageView(new Image(getClass().getResourceAsStream("/images/addPartner.png")));
        Node modifyPartnerPict = new ImageView(new Image(getClass().getResourceAsStream("/images/modifyPartner.png")));
        Node transferPict = new ImageView(new Image(getClass().getResourceAsStream("/images/transfer.png")));
        Node colleagueNode = new ImageView(new Image(getClass().getResourceAsStream("/images/collegaue.png")));
        Node shopsNode = new ImageView(new Image(getClass().getResourceAsStream("/images/shop.png")));
        Node modifyWineDataPict = new ImageView(new Image(getClass().getResourceAsStream("/images/modifyPartner.png")));
        Node exitPict = new ImageView(new Image(getClass().getResourceAsStream("/images/exit.png")));
